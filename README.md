...
Before running anything, do the following install instructions: 1) npm install 2)npm install --save react-router-dom 3) npm install --save reactstrap react react-dom
